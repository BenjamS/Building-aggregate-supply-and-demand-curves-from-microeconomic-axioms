...
Matehmatically, the change in farm level net benefit resulting from introduction of the new technology is measured as the change in the farm's optimized objective function $\mathcal{L}^*$ or "net benefit envelope", which is just the objective function $\mathcal{L}$ evaluated at the optimal yield $y^*$.

\begin{equation}
\mathcal{L}^* = \mathcal{L} \bigr_{y = y^*} = P y^* - \lambda (C^* - B)
\end{equation}
...
Here it is important to keep in mind that the release and uptake of yield enhancing technology tends to boost supply, which in turn (by Axiom 3) lowers the output price $P$. At the same time, uptake of the new technology usually implies increased use of (i.e. demand for) inputs, which (again by Axiom 3) drives up input prices. Also, the price of improved seeds (an input) is typically higher than the price of the status quo seed variety.
...
The change in farm net benefit resulting from input enhancing technology is considerably more complex than the change resulting from basal yield enhancing technology due to the presence of $\alpha_i$ in multiple terms ($h$, $\beta_w$, $\beta_x$) within the net benefit envelope.

The marginal change in net benefit given a $1$% increase in one of the partial yields is expressed as follows.

\begin{equation}
\begin{split}
\frac{\partial \mathcal{L}^*}{\partial \ln(y_i)} &= \frac{\partial \mathcal{L}^*}{\partial \alpha_i} \\
&= (1 - h) \left(y^* \frac{\partial P}{\partial \alpha_i} + P \frac{\partial y^*}{\partial \alpha_i} \right) + P y^* \frac{\partial}{\partial \alpha_i} (1 - h) \\
&= P y^* \left(\frac{\partial \ln(y^*)}{\partial \alpha_i} + \frac{\partial \ln(P)}{\partial \alpha_i} - 1 \right) \\
&= (1 - h) P y^* \left(\frac{\partial \ln(y^*)}{\partial \alpha_i} + \frac{\partial \ln(P)}{\partial \alpha_i} - \frac{1}{1 - h} \right)
\label{eq:dLdai}
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\frac{\partial \ln(y^*)}{\partial \alpha_i} &= \frac{\ln(y^*)}{1 - h} + \frac{1}{1 - h} \left(\ln \left(\frac{P}{\lambda} \right) + h \frac{\partial \ln(P)}{\partial \alpha_i} - \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} - \ln(w_i) + \ln(\alpha_i) + 1 \right) \\
&= \frac{1}{1 - h} \left( \ln(y^*) + \ln \left(\frac{P}{\lambda} \right) + \left( \ln(y^*) + \ln \left(\frac{\alpha_i}{w_i} + h \frac{\partial \ln(P)}{\partial \alpha_i} - \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} \right) \right)
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
\frac{\partial \ln(y^*)}{\partial \alpha_i} &= \frac{1}{1 - h} \left(\ln(y^*) + \frac{1}{h} ((1 - h) \ln(y^*) - \ln(y_0) - \ln(\beta)) + \ln \left(\frac{\alpha_i}{w_i} \right) + h \frac{\partial \ln(P)}{\partial \alpha_i} - \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} + 1 \right) \\
&= \frac{1}{1 - h} \left( \frac{1}{h} (\ln(y^*) - \ln(y_0) - \ln(\beta)) + \ln \left( \frac{\alpha_i}{w_i} \right) + h \frac{\partial \ln(P)}{\partial \alpha_i} - \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} + 1 \right)
\end{split}
\end{equation}

Substituting this expression for $\frac{\partial \ln(y^*)}{\partial \alpha_i}$ in equation \ref{eq:dLdai} then gives

\begin{equation}
\begin{split}
\frac{\partial \mathcal{L}^*}{\partial \ln(y_i)} &= (1 - h) Py^* \left[ \frac{1}{1 - h} \left( \frac{1}{h} (\ln(y^*) - \ln(y_0) - \ln(\beta)) + \ln \left( \frac{\alpha_i}{w_i} \right) + h \frac{\partial \ln(P)}{\partial \alpha_i} - \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} + 1 \right) + \frac{\partial \ln(P)}{\partial \alpha_i} - \frac{1}{1 - h} \right] \\
&= Py^* \left[ \left( \frac{1}{h} (\ln(y^*) - \ln(y_0) - \ln(\beta)) + \ln \left( \frac{\alpha_i}{w_i} \right) + h \frac{\partial \ln(P)}{\partial \alpha_i} - \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} + 1 \right) + (1 - h) \frac{\partial \ln(P)}{\partial \alpha_i} - 1 \right] \\
&= Py^* \left[ \frac{1}{h} (\ln(y^*) - \ln(y_0) - \ln(\beta)) + \ln \left(\frac{\alpha_i}{w_i} \right) + \frac{\partial \ln(P)}{\partial \alpha_i} - \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} \right]
\end{split}
\end{equation}

The adoption condition $\frac{\partial \mathcal{L}^*}{\partial \ln(y_i)} > 0$ then implies

\begin{equation}
\begin{split}
\frac{1}{h} (\ln(y^*) - \ln(y_0) - \ln(\beta)) + \ln \left(\frac{\alpha_i}{w_i} \right) + \frac{\partial \ln(P)}{\partial \alpha_i} - \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} > 0 \\
\frac{1}{h} (\ln(y^*) - \ln(y_0) - \ln(\beta)) &> \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} - \frac{\partial \ln(P)}{\partial \alpha_i} - \ln \left(\frac{\alpha_i}{w_i} \right) \\
\ln(y^*) &> h \left( \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} - \frac{\partial \ln(P)}{\partial \alpha_i} + \ln \left(\frac{w_i}{\alpha_i} \right) \right) + \ln(y_0) + \ln(\beta) \\
y^* &> y_0 \beta \left(\frac{w_i}{\alpha_i} \right)^h e^{h \left( \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} - \frac{\partial \ln(P)}{\partial \alpha_i} \right)}
...
How do adopting farms change their output given the new technology? Equation \ref together with the output expansion condition $\frac{\partial \ln(y^*)}{\partial \alpha_i} > 0$ imply that adopting farms increase output if

\begin{equation}
\begin{split}
\frac{1}{h} (\ln(y^*)) - \ln(y_0) - \ln(\beta) > \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} - \frac{\partial \ln(P)}{\partial \alpha_i} + \ln \left(\frac{w_i}{\alpha_i} \right) - 1 \\
\ln(y^*) &> h \left( \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} - \frac{\partial \ln(P)}{\partial \alpha_i} + \ln \left(\frac{w_i}{\alpha_i} \right) - 1 \right) + \ln(y_0) + \ln(\beta) \\
y^* &> y_0 \beta \left(\frac{w_i}{\alpha_i} \right)^h e^{h \left( \boldsymbol{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \alpha_i} - \frac{\partial \ln(P)}{\partial \alpha_i} + \ln \left(\frac{w_i}{\alpha_i} \right) - 1 \right)}
...
\begin{equation}
e^{h \left( (1 - h)\frac{\partial \ln(P)}{\partial \alpha_i} - 1 \right)}
\end{equation}
...
\begin{equation}
y^*_y = e^{h \left( (1 - h)\frac{\partial \ln(P)}{\partial \alpha_i} - 1 \right)} y^*_{\mathcal{L}}
...
Estimation of the technology adoption rate hinges upon whether the technology is basal yield or input enhancing, and hence upon the corresponding assumed density function (Axiom 4).

In the case of basal yield enhancing technology, inequality \ref{eq:ydAdoptCondy0} implies the following adoption rate. 

\begin{equation}
a = \int_0^{\partial \ln(y_0)} g(u) du \:\:\:;\:\: u = \boldsymbol{\alpha} \cdot \partial \ln(\mathbf{w}) - \partial \ln(P)
\end{equation}

Where $g(\boldsymbol{\alpha} \cdot \partial \ln(\mathbf{w}) - \partial \ln(P))$ is the assumed density of $\boldsymbol{\alpha} \cdot \partial \ln(\mathbf{w}) - \partial \ln(P)$.
...
Recalling the expression for $\frac{\partial \ln(\mathcal{L}^*)}{\partial \ln(y_0)}$ derived in equation \ref\ref{eq:prodNBy0}, this can be rewritten

\begin{equation}
\begin{split}
\psi^S &= \rho_0 \left( 1 - \mathbf{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \ln(y_0)} + \frac{\partial \ln(P)}{\partial \ln(y_0)} \right) P \int y^* f(y^*) d y^* \\
&= \left( 1 - \mathbf{\alpha} \cdot \frac{\partial \ln(\mathbf{w})}{\partial \ln(y_0)} + \frac{\partial \ln(P)}{\partial \ln(y_0)} \right) P Q
\end{split}
\end{equation}
...
### Aggregate change in net benefit, input enhancing technology
