...
The method of calculating consumer surplus---as the area between the demand curve and the equilibrium price---is a case in point. This method was proposed by Depuit in 1844, and later advocated by Marshall in 1895, as a surmise without any theoretical justification [@currie1971concept; @burns1973note]. Most economists, even today, would probably struggle to explain the connection between Depuit's calculation and the verbal definition of consumer surplus given above. Nonetheless, Depuit's surmise persisted through more than a century of heated debate, unquestioned, while many other less critical aspects of consumer's surplus fell under intense scrutiny. Only in 1973 did a (seriously flawed) theoretical basis for Depuit's calculation appear in print [@burns1973note]. [flawed because lambda in the demand equation, thus integrating doesn't give the area under demand curve but rather the area under the demand curve times lambda, also an issue with linearly homogenous utility]
...
The upshot: After more than century of debate, the consensus among economists seems to be that the economic surplus measure of welfare is, at best, "useful as a heuristic device---so long as its limitations are understood" [Little in @currie1971concept]. (Empirically, Johnson [-@johnson1985imprecision] and Bacon [-@bacon1995measurementstudies] have shown these limitations to be quite severe.) The persistent use of the economic surplus measure in spite of its fundamental drawbacks is attributed to a dismal lack of "workable alternatives", and to the ever growing demand for welfare impact studies to inform policy decisions [@currie1971concept].
