...
\begin{equation}
\begin{split}
E[E[q^*(T)]]\bigr|_{t = 0} &= E[\tilde{q}^*(T)]\bigr|_{t = 0} \\
Var[\ln(E[q^*(T)])]\bigr|_{t = 0} &= Var[\ln(\tilde{q}^*(T))]\bigr|_{t = 0} \\
&= s_q^2 \tau
\end{split}
\end{equation}


Substituting Equation \ref{eq:yStarC0b} for $E[\tilde{q}^*(T)]\bigr|_{t = 0}$   and so the aggregate supply function can be rewritten as follows.
<!-- E[y^*]\bigr|_{t = 0} = y_0 \theta \left( \frac{C^*}{h} \right)^h -->
<!-- \label{eq:yStarC0b} -->
