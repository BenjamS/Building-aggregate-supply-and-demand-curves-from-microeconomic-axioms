...
Empirically, the mapping between expedient model parameters and relevant, measurable, phenomena---i.e., technology, input prices, agroclimatic conditions, demographic variables, etc.---is tenuous at best, leaving very little basis upon which to assess the plausibility of different parameterizations of a given exogenous shock, or to attribute modeled impacts to the exogenous shock with confidence. In the assessment of technology shocks, for example, there is no clear way to accurately represent the given technological shock in terms of a change in the aggregate supply curve's parameters, or even to know which parameters are affected by the technological change. Instead of attempting to represent the technological shock directly, [and thence to endogenously deduce the farm supply and expenditure response based on economic theory,] then, expedient models typically forgo any explicit modeling of the relation between technology change and management change, and instead introduce the farm supply and/or expenditure response to technology exogenously, based on experimental data and consultation with scientists involved in the research. Model guidelines might advise care be taken to adjust the elicited estimate for differences between economically and agronomically optimal yields, and to adjust for the glaring conflict of interest inherent in the expert opinion of scientists closely involved in the research under evaluation, but offer little in the way of a practical, formal method for achieving such adjustments. (Otherwise, why not just model the supply/expenditure response to technology endogenously in the first place?) The remainder of the impact assessment---e.g., the calculation of the aggregate supply curve shift, the change in economic surplus, etc.---bears many of the outward marks of a "rigorous economic analysis"; but the end result tends to hinge critically on the exogenously introduced supply/expenditure response to technology, which has no basis in economic theory. Insofar as the end result is prefigured by the initial exogenous specification of supply/expenditure response to technology, then, the impact assessment is more properly an impact _assertion_, and an exercise in _petitio principii_.
...
Some expedient forms also introduce awkward artifacts---such as the possibility of negative supply quantities and/or of farms producing for free, in the case of the linear aggregate supply curve---which further undermine the model's explanatory power. A great many methodological headaches are accumulated in the name of expedience...quote about curve not being valid except at the equilibrium price?
