...
Progress in this direction is deterred by a general perception that the task is impossible:

>"What does economic theory tell us about the nature of ...[research induced aggregate supply curve] shifts? Unfortunately, not very much. To be confident about this aspect of the problem would require either (a) precise econometric evidence or (b) detailed information on the effects on individual agents, details of industry structure including details on exit and entry of firms, and a complete theory of aggregation. This information is not available; assumptions are unavoidable" [@alston1995science].

The remainder of this article is essentially one long disagreement with this passage. We disagree with the perception that economic theory does not tell us very much about the nature of aggregate supply curve shifts. On the contrary, economic theory gives us a set of axioms upon which it is possible to construct the "complete theory of aggregation" that Alston et al. [@alston1995science] suppose to be impossible. 
...
For those who share our suspicion, here we derive an aggregate supply curve from five Axioms. The derived curve explicitly accounts for farm entry/exit, such that supply response to shocks can be decomposed into yield and entry/exit components. The term in the function regulating farm entry/exit turns out to be surprisingly instructive, as it is proportionate to the probability that output price will be greater than mean farm's expected cost per unit output at the time of sale (i.e. the mean farm's probability of profit). The curve is empirically transparent, i.e. its parameters have a straightforward interpretation in terms of concrete, measurable phenomena, such that exogenous shocks may be modeled precisely and transparently.
The price elasticity of aggregate supply resulting from this functional form is the farm level price elasticity of supply plus a term capturing farm entry/exit. The research induced supply curve shift is complex. ...adoption... derivative of aggregate supply with respect to price volatility, multiple levers at the policy maker's disposal.
