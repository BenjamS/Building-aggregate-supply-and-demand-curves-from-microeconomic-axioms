...
```{r Fig1, fig.show = "hold", fig.width = 5, fig.height=4, fig.align="left", fig.cap="\\label{fig:mzP}Maize monthly price series during main season (March-August) at primary markets in Kenya. Price data are from the World Food Program.", echo = FALSE}
#======================================================================
...
gg <- gg + geom_ribbon(aes(x = `Expected price (KES/kg)`,
                           ymin = `Expected supply, low rainfall (10%)\n(million MT)`,
...
dfLine <- dfLine %>% gather(rainLev, `Expected supply\n(million metric tons)`, `Normal rainfall`:`Extremely low rainfall (10%)`)
...
Studies have generally found maize price elasticity of supply in Kenya to be far below unity [@abodi2021supply; @onono2013response; @olwande2009supply]. In one study,
Onono et al.'s estimate of price elasticity of supply: 0.365 [@onono2013response], quite close to what the present model gives when evaluated at the expected price around 2006-2007.
