...
Specification:
Model is essentially a function of cost/acre, binary endowments (including the adoption of hybrid maize), management/agroclimatic/demographic control variables, and the prices of the main chemical inputs. Seed kg/acre is treated here as a management control variable, as opposed to a discretionary input, because it is effectively a measure of planting density, which is determined by agroclimatic constraints. Child family labor is likewise treated as a control variable because it effectively measures a poverty constraint as opposed to a discretionary management variable.
...
The data used below detail farm level input and output quantities and prices for the 2007 main maize season on 942 farms across 20 sub-counties in Kenya. The data are a subset of a panel covering the main and short seasons of multiple crops for the years 2000, 2004, 2007, and 2010, originally gathered by the Egerton University Tegemeo Institute of Agricultural Policy and Development in partnership with Michigan State University, under the auspices of a USAID project [@maizeData]. Apart from the usual inputs and outputs (fertilizer, P&D control chemicals, and hired labor), the data also include detailed information on family labor, agroclimatic factors, demography, and infrastructure.

Descriptive histograms of the dependent and independent variables appearing in the farm level model are presented in Figure .... Bin vars in Figure... mean farm size is small, mean yield lognormally distributed, A more detailed description of the data and processing, including summary statistics, is given in Appendix 2.
