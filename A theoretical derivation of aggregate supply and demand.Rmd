...
Impact assessments vary considerably with the choice of functional form and type of supply curve shift [@alston2009economic]. With no clear theoretical or empirical premise upon which to recommend one form over another, little confidence can be attached to such results. In particular, calculations of consumer and producer surplus 

Because the conventional models are not formally derived from standard axioms, 
The literature characterized above is an academic exercise since 
...
As a final line of defense, proponents of the conventional supply curve  Progress in this direction has long been discouraged by a widespread perception that the task is impossible [cloud of pessimism]. In their highly influential book, e.g., Alston et al. [-@alston1995science] write:
...
## Relevance to food policy and distributional  and price risk policy questions


[@norton1992economic; @alston1995science] characterize as an equity-efficiency tradeoff, such that the more of one you have, the less of the other...
but no, subsequently rejected [@byerlee2000targeting;@byerlee2009agriculture]

[@partridge1997inequality; @easterly2007inequality; @berg2011equality; @berg2012makes; @ostry2015inequality; @berg2017inequality; @berg2018redistribution; @ostry2021growth].
