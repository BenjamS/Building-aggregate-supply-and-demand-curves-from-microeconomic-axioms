...
then it is not readily apparent from expedient specifications of $Q$ what the functions $q^*$ and $\rho(q^*)$ are, nor whether they are consistent with microeconomic principles. Critically, expedient specifications of $Q$ also omit or gloss over farm entry and exit---i.e. the domain of profitable production $(\underline{q}^*, \overline{q}^*)$---such that it is not possible to decompose changes in aggregate supply into yield and farm entry/exit components. Wohlgenant [-@wohlgenant1997nature] demonstrates analytically that impact assessment results are substantially distorted by omissions and/or oversimplifications in this regard. Some expedient forms also introduce awkward artifacts---such as the possibility of negative supply quantities and/or of farms producing for free, in the case of the linear aggregate supply curve---which further undermine the model's explanatory power.
...
In the assessment of technology shocks, particularly, expedient models offer no way to accurately represent the given technological shock in terms of a change in the aggregate supply curve's parameters, or even to know which parameters are affected by the technological change. Instead of attempting to represent the technological shock directly, then, expedient models typically forgo any endogenous economic modeling of the relation between technology and management, and instead introduce the farm supply and/or expenditure response to technology exogenously, based on field trial data and consultation with scientists involved in the research under evaluation. Model guidelines might offer some words of warning about the difference between economically and agronomically optimal yields/expenditures, and about the glaring conflict of interest inherent in the expert opinion of scientists closely involved in the research under evaluation; but very little in the way of actionable advice is actually given.^[If it were, then no words of warning about economic versus agronomic yields would be necessary, as the advice would presumably already be integrated in the model. To redress conflicts of interest, Alston et al. [@alston1995science] prescribe the creation of "an environment of peer review and, perhaps, a competitive process (e.g., Delphi methods) that will reduce the potential for personal incentives to bias estimates of technical parameters, and...an institutional setting in which scientists will be held accountable for systematic biases in their estimates of research impact". Admirable aspirations, but not actionable. If research institute directors cannot effect such cultural changes over the course of their multi-year tenure, how can the economist tasked with the impact assessment, often hired as a short term consultant, be expected to do so within the timeframe and budget of the assessment?] The subsequent step of determining how the exogenously introduced farm level supply/expenditure shock then manifests at the aggregate level is likewise less a matter of endogenous economic modeling than it is of exogenous guesswork translated into mathematical symbols. The standard assumption since the 1990s is that the shock manifests as a parallel shift of the aggregate supply curve [@alston1995science]. But no theoretical or empirical grounds exist for this preference over, say, a supply curve pivot, or a combination of pivot and shift, which would result in a very different calculation of net benefits [@alston1995science; @alston2009economics]. [Again, because there is no clear mapping between model parameters and empirical phenomena, then, by construction, the model can offer no .]
...
The final step of calculating net benefits in terms of discounted economic surplus, adjusted for probability of success, expected adoption rate, time lags in research and adoption, capital depreciation, and other exogenously collected parameters, bears many of the markings of a rigorous economic assessment. But the result of this calculation tends to be largely prefigured by the initial, exogenously determined farm supply/expenditure response to the technology change, and to the translation of the farm response to an aggregate response, just discussed above.[neither of which have any solid basis in economic theory.] In this measure, then, the "impact assessment" is, more properly, an impact _assertion_ bordering on _petitio principii_, and very nearly a case in point of what Paul Romer calls "mathiness".
...
Or of what Von Neumann and Morgenstern had in mind when they complained that
...
Progress in this direction has long been discouraged by a widespread perception that the task is impossible [cloud of pessimism]. In their highly influential book, e.g., Alston et al. [-@alston1995science] write:
...
It is not economic theory, but rather an expedient methodology which, by construction, precludes the possibility of explicit, endogenous modeling of the supply response to technology (or any other exogenous) shocks, that tells us "not very much" about the nature of the aggregate supply response. I.e. it tells us nothing _by construction_, not because theory tells us nothing. The present article, by contrast, explores what economic theory actually can tell us.
...
To be clear, we agree that the "precise econometric evidence or...detailed information" that the authors refer to is generally not available, but disagree with the suggestion that economic theory offers nothing in its stead. On the contrary, the whole point of having a theory is precisely to draw inference when available information provides no clear answer to our questions. [If the inference proves wrong, then the theory is corrected.] It is not theory, then, but rather models not explicitly built up from theory, that tell us "not very much" about the nature of supply curve shifts.  ...And that "assumptions are unavoidable" insofar as the 5 axioms are unavoidable, but assumption of the supply response to exogenous technology shock, which is nearly the same as assuming the result of the impact assessment, is not unavoidable. On the contrary, it is precisely the work of the economist to model the supply response to technology shocks endogenously.
...
As mentioned above, a great many methodological headaches are accumulated in the name of methodological expedience. In the process I hope to show that the most expedient way is also the most theoretically rigorous. Expedience and rigor go hand in hand, not a tradeoff.
