...
...it is shown that or it follows that the SOC is...h(1 - h) which implies global concavity in inputs...
...
The impact of yield scaling technologies and/or management practices on farm supply and expenditure can be represented through perturbations of the TFP parameter ($g_0$). 
...
Note that the increase in TFP is the same regardless of the starting value of $g_0$.
<!-- , which varies across the population because the binary endowments $b_{i \in [1,4]}$ vary. -->
...
Changes in technology can be represented as changes in the TFP parameter $g_0$.


and hence the expenditure TFP $v_0$. 

Can also explore changes in the degree of homogeneity $h$.


The yield response to changes in TFP and price must be calculated endogenously, not exogenously asserted based on expert opinion or agronomic yields on test plots cannot be taken...   Technology change cannot
