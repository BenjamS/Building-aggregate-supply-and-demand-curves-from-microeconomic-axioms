...
Such that conditional mean of $y^*$ truncated at $C^{\#} < P$ can be parsed as follows.
...
Whence $E[y^*]$ follows as a function of observed or derived parameters $E[y^*|C^{\#} < P]$, $m_{\#}$, and $s_{\#}$.
<!-- \begin{equation} -->
