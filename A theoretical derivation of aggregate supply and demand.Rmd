...
anomVec <- c()
for(i in 1:(nYr - 1)){
  thisDate <- as.Date(paste0(as.character(yrVec[i]), "-02-01"))
...
#mEcSharpT0 <- log(P02007) + (mP2006 - sP2006^2 / 2) * th + log(h)
#sP2006 * sqrt(th)
#---
...
gg <- ggplot(dfEQsT0, aes(x = EPT0, y = ProbProfitMeanFarm))
gg <- gg + geom_line()
