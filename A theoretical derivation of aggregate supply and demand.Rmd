...
muEyStarT0trunc <- mean(EyStar2 * kRn^-kappaRn)
#----------------------------------------------------------------------
...
QsFun <- function(muEyStarT0, EPT0, fracVec, h, kappaRn, muArea,
                  muEcSharpT0, mP, sP, th, Nf){
    eta <- h / (1 - h)
    muKrnKapEtaH_up <- mean(2^(kappaRn * eta / h))
    muKrnKapEtaH_lo <- mean((1 / 2)^(kappaRn * eta / h))

  EPT0vec <- fracVec * EPT0
...
fracVec <- seq(0.01, 3, length.out = 50)
dfQs <- QsFun(muEyStarT0,
                  EPT0 = EPT02007, fracVec,
                  h = hCoef, kappaRn, muArea,
                  muEcSharpT0 = muEcSharpT0,
                  mP = mP2006, sP = sP2006, th, Nf)
#---------------------------------------------------------------------
gg <- ggplot(dfQs)
