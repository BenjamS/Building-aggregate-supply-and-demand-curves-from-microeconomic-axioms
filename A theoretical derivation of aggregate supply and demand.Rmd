...
In ex-ante impact assessments of exogenous changes in agricultural technology and agroclimatic conditions, aggregate supply curves are often specified primarily for the purpose of facilitating certain calculations (usually of producer and consumer surplus), with secondary consideration given to the plausibility of the theoretical underpinnings implied by the choice of functional form. The resulting models are then, by construction, theoretically opaque.
...
The parameterization of expedient specifications also tends to be highly abstract, with no clear mapping to the relevant measurable, real world phenomena---i.e. technology, input prices, agroclimatic conditions, demographic variables, etc.---leaving very little basis upon which to assess the plausibility of different parameterizations of a given exogenous shock. Some expedient forms also introduce awkward artifacts---such as the possibility of negative supply quantities and/or of farms producing for free, in the case of the linear aggregate supply curve---which further limit the model's explanatory power.
...
Of course, expedient models are built for expedience, not explanatory power. However, the question arises as to whether the numerous methodological headaches outlined above (and treated in more detail in the literature review below), that are accumulated in the pursuit of expedience, outweigh the expedience gained in terms of tractable . This is a question that must be ...each modeler, case by case. ...currently no other option. for those willing to trade ease of economic surplus calculations for greater theoretical transparency. ...AND evidence that donors have grown impatient with the theoretical opacity of expedient forms...
