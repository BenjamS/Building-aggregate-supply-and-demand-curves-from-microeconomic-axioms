...
Note that optimal farm expenditure per acre $C^*$ remains a deterministic variable. This is because $C^*$ primarily refers to land preparation, seed, fertilizer and chemical pest control. It may also include harvest and some post harvest costs (e.g., shelling, stooking, transport), but the most significant cost components are typically known (executed or planned) at planting time.
