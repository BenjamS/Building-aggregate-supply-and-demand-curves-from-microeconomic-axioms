...
main novel contributions resulting from the axiomatic approach: endogenous farm level supply response, transparent aggregation, endogenous adoption rate. Because of this the evaluation of researh induced shifts in aggregate supply and welfare are also fundamentally different from convention.
...
Models of agricultural supply and of the impact of new technology (or any exogenous shock) are useful to agricultural policy formation insofar as they can map out the plausible outcome space for a relevant range of price assumptions and policy lever settings (subsidies); and insofar as this mapping is transparently rooted in an empirically vetted theoretical foundation.

This involves, more specifically,... The aggregate supply of agricultural commodities hinges critically on the shape of the yield distribution and on farm entry and exit in response to price changes. The impact of new technology (or any exogenous shock) on aggregate supply and welfare depends upon endogenous, economically rational decision making by farmers in response to the exogenous shock and associated changes in input/output prices and any subsidies. The adoption rate is an aggregate expression of the farm level response, and is thus also endogenous to the impact.

The conventional approach to modeling aggregate agricultural supply and the impact of new technology described in the introduction does not explicitly account for any of this [these critical ocmponents]. It effectively assumes the farm level response as an exogenous input into the modeling. There is no explicit modeling of input price changes, and the adoption rate is also assumed as exogenously given [earlier entry/exit]
...also no explicit modeling of meteorological factors.
The conventional approach to modeling aggregate agricultural supply and the impact of new technology described in the introduction is essentially a mathematical description of an assumed supply response to the exogenous technology shock. It takes no account of changes in input prices due to changes in input demand, subsidies, nor how this   As such, it effectively treats the supply response as though it too were exogenous, takes no account of changes in input prices   Here an alternative framework is derived from 5 non-controversial axioms which explicitly models the 

comparative statics
consumer welfare due to price decrease
