...
In agricultural ex-ante impact assessments of new technology, aggregate supply and demand curves are often specified primarily for the purpose of facilitating certain calculations (usually of producer and consumer surplus), with secondary consideration given to the plausibility of the theoretical underpinnings implied by the choice of functional form.

This often results in awkward model artifacts---such as the possibility of negative production quantities and/or of farms producing for free, in the case of linear supply functions---which requires us to interpret the model as a local approximation to the "true" function, with validity thereby restricted to a small domain of convergence around the starting equilibrium point.

More importantly, such models, by construction, lack a theoretical framework to guide the interpretation of abstract model parameters in terms of real world parameters---i.e. prices, technology, agroclimatic conditions, etc.---and vice versa. ...Wd be nice to consider a range of scenarios covering a range of potential input price increases versus technology shocks, but this not possible ... not clear why adoption rate takes a certain value... or how the shock affects the entry and exit of farms... nor how the shock affects the aggregate...  nor which centiles adopt...The representation of exogenous shocks to real world parameters in terms of model parameters thus largely boils down to a matter of modeler fiat. Insofar as modeling results hinge upon the parameterization of shocks, the conclusions of the impact assessment are, in this measure, also by fiat; and the whole process is thereby reduced to an exercise in petitio principii. This obviously complicates subsequent defense of the modeling results, especially if the modelers and/or their source of funding have a vested interest in the results.
...
The pursuit of expedience then accumulates numerous complications which call into wuestion whether the expedience gain is outweighed by the many complications called forth in this pursuit....would it not be better to just sit down and work through a theoretical derivation of the aggregate curve from a set of axioms? Or at least try and see what happens?

The results of ex-ante impact assessments depend critically on these arbitrary mappings. introduces awkward artifacts, 

... no account of farm entry and exit...Also ... The standard response to such commentary---that the specified forms are meant as local approximations---only serves to increase the theoretical opacity. anything goes then.... They may also introduce contradictions of microeconomic axioms. ... 


The results of the modeling exercise may  ...matter of preference...

 ...conflict of interest...


You may say so what. Well, it is well documented that  there is growing evidence that donors have stopped believing ex-ante impact assessments.


The results of assessments can depend critically upon the choice of functional form...difficult to defend the choice of one form over another, and thus the results themselves. ...at a time when it is now widely recognized that hundreds of ex-ante impact assessments have 

While such forms are expedient for certain calculations, it also 

...and no explicit modeling of farm entry and exit...
...distinguishing between real results and artifacts of the model.
...local approximation...
Without a theoretical framework to map model parameter values and functional forms to real world variables and situations, it may then be challenging to defend the results, or to justify one functional form over another. Results of ex-ante impact assessments depend critically upon the choice of functional form.

Here we present a theoretical derivation of an aggregate supply curve from the following Axioms:
...
-Can't then justify decision of one form over another...important as results depend critically on choice of form......producer surplus either increases or declines...  the justification boils down to "because I say so".
...
...a bit of a remedial feel at times, patience, as there are some surprises at the end...in particular, the impossibility of constant returns to scale. These decisions are obviously in conflict with known theory (entry and exit of firms), to facilitate calculation of economic surplus...but the choice of functional form affects these calculations, and the cavalier specification of the curves means they can offer no explanation of why the results of one specification should be trusted over another. ...paraphrase romer? "because I say so" ["If the author can make up an imaginary variable, "because I say so" seemslike a pretty convincing answer to any question about its properties."]
