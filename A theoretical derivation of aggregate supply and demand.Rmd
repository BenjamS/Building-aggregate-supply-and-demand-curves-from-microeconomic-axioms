...
\begin{equation}
y = y_0 \prod_{i = 1}^{n_k} k_i^{\kappa_i} \prod_{i = 1}^{n_x} x_i^{\alpha_i} \:\:;\:\:\: y_0 = e^{\alpha_0}
\label{eq:cobbDoug2}
\end{equation}
