...
2007 15 May assessment - long rains were delayed and short rains harvest delayed due to unseasonal extension of short rains into February, led to reduced main season planting [GIEWS/MoA 2007].
...
EQsFun <- function(EPT0, muEyStarT0, mEcSharpT0, sEcSharpT0, h, muArea, Nf, kappaRn){
  ...
  colnames(dfOut) <- c("Expected price (KES/kg)", "Expected supply\n(million MT)",
                       ...
                       "Expected supply, low rainfall (10%)\n(million MT)",
                       "Price elasticity\nof supply",
...
EQsT2007Sep11usda <- 2.56 # USDA FAS
EQsT2008Jul15MoA <- 2.16 # GIEWSDrought, planted acres lower due to post election violence
...
gg <- gg + geom_ribbon(aes(x = `Expected price (KES/kg)`,
                       ...
                       fill = 'blue', alpha = 0.2)
dfLine <- dfOut[, 1:5]; colnames(dfLine)[-1] <- c("Normal rainfall", "High rainfall (150%)", "Low rainfall (50%)", "Extremely low rainfall (10%)")
