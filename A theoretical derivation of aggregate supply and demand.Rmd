...
then it is not readily apparent from conventional linear and CES specifications of $Q$ what the function $q^*$ is, nor whether it is consistent with microeconomic theory. Critically, the farm production density $\rho$---which captures heterogeneity in farm endowments---and domain of profitable production $(\underline{q}^*, \overline{q}^*)$ are likewise unclear, precluding any analysis that would decompose supply response to exogenous shocks into yield and entry/exit components. That is to say, the conventional models either do not explicitly account for heterogeneously endowed farm populations, or, worse still, assume a population of homogeneously endowed identical marginal farms.
...
Critics have long noted as much, if perhaps in an more understated way. Rose [-@rose1980supply], for example, notes that
...
In other words, we do not need better mathematical descriptions of an exogenously assumed supply perturbation, but rather a thorough mathematical understanding of why the supply perturbation happens in the first place. I.e., we need mathematical models that endogenously predict/simulate the supply curve perturbation in response to different kinds of exogenous shock, as opposed to a mathematical description of an assumed supply curve shift in response to the shocks.

For those interested in endogenous modeling of the supply response to exogenous shocks, here an aggregate supply curve function is derived from the following five standard economic axioms.
...
Effective food-price and agricultural research policy formation requires careful assessment not only of the magnitude of net benefits of a given intervention, but also of resulting consumer-producer tradeoffs (the "food price dilemma"), as well as the distributional effects of the intervention across income levels. In recent decades, rural-urban migration, and hence rural employment (farm entry/exit), is also a major concern [@lall2006rural; @nori2020migration; @crush2013linking]. Proponents and critics alike acknowledge that conventional functional forms are ill suited to the assessment of any of these distributional issues [@alston2009economic; @alston1995science; @lindner1978supply; @rose1980supply; @wohlgenant1997nature]. The conventional approach also takes no account of commodity price risk and risk mitigating mechanisms, which have also received increasing attention in agriculture research and policy discussions [@bellemare2020producer; @byerlee2006managing].
