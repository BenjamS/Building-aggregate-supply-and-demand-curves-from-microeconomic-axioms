...
(Where, in the latter case, the $\hat{\theta}_k$ in $\hat{\theta}$ equals $k_a^{\kappa_a + 1} \prod_{i \neq a} k_i^{\kappa_i}$.)
...
the Phi term captures entry/exit
...
# An illustrative use case: Parameterization and estimation of the aggregate supply curve using Kenya farm survey data

## Data

The farm data used below cover the 2007 main maize season on 942 farms in 20 different counties of Kenya. The data are a subset of a much larger panel covering the main and short seasons of multiple crops for the years 2000, 2004, 2007, and 2010, originally gathered by the Egerton University Tegemeo Institute of Agricultural Policy and Development in partnership with Michigan State University, under the auspices of a USAID project [@maizeData]. The data include detailed information on quantities of numerous types of organic and inorganic fertilizers, pest/plague control chemicals, and hired and family labor. A wide variety of demographic and infrastructural control variables, as well as input and crop prices, are also included. summary statistics are provided in the appendix...variables on which focus...bin vars
