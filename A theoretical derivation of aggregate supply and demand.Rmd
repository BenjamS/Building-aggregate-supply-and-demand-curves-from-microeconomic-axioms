...
The percentage change in aggregate supply given a 1% change in TFP, assuming 100% adoption, follows from Equation ...
...
\begin{equation}
\frac{\partial \ln(E[Q(T)]|_{t = 0})}{\partial \ln(g_0)} = A \frac{\partial \ln E[y^*(T; k_m(T))]|_{t = 0}}{\partial \ln(g_0)}
\end{equation}
