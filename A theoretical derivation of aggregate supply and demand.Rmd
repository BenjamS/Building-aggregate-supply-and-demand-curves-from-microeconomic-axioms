...
As a final line of defense, proponents of conventional aggregate supply curves argue that assumptions regarding supply curves and exogenous shifts, however implausible they might be, are unavoidable. In their highly influential book, e.g., Alston et al. [-@alston1995science] write:
...
To be clear, the "precise econometric evidence or...detailed information" that the authors refer to is, indeed, generally not available; but the suggestion that economic theory offers nothing in its stead is simply mistaken. One of the key purposes of having a theory is to draw inference when detailed information is unavailable or otherwise provides no clear answer to our questions. And yes, "assumptions are unavoidable"---but in the sense that standard microeconomic axioms 1-5 in the Introduction are unavoidable, not in the sense of exogenously assuming a supply response instead of deriving it endogenously from said axioms.

Not economic theory, then, but rather a mathematical formulation which, by construction, precludes endogenous modeling of the aggregate supply response to exogenous shocks, is what tells us "not very much" about the the aggregate supply response to exogenous shocks.
...
Partial equilibrium analysis on the basis of conventional aggregate supply and demand curves is of little to no use in the assessment of any of these issues. Impact assessment results regarding the distribution of net benefits among producers and consumers vary considerably with the choice of functional form and type of supply curve shift [@alston2009economic]. Specifically, assessments based on the CES supply curves can result in consumer-producer tradeoffs, whereas assessments based on the linear supply curve guarantee increases in both consumer and producer welfare. With no clear theoretical or empirical premise upon which to recommend one set of results over another, little confidence can be attached to any of them. In practice, most studies choose the linear specification [@hurley2014re; @alston2000research], which results in the highest net benefit and avoids uncomfortable food-price dilemma [@alston2009economic].
conspicuous
the whole point of the form is to facilitate calculations of producer and consumer surplus, which ultimately cannot be used to draw meaningful conclusions and inform policy.


...distributional
The assumption of identical marginal firms implicit in the linear specification precludes any assessment of net benefit distribution across income levels. In some sectors, one might reasonably justify this assumption by invoking competitive long run equilibrium. The case for competitive long run equilibrium is strained in the primary sector, however, where one typically sees an abundance of inframarginal farms in operation. Wohlgenant [-@wohlgenant1997nature] ...

...equity-efficiency

...

..."Many economists argue that agricultural research is a relatively poor instrument for achieving non-efficiency objectives" [@norton1992economic]. Assume an equity-efficiency tradeoff that doesn't exist.

In some sectors, one might reasonably dismiss the need to account for heterogeneously endowed firms by invoking competitive long run equilibrium. The case for competitive long run equilibrium is strained in the primary sector, however, where one often sees an abundance of inframarginal farms in operation. ( provides an analytical exploration of the distortions that can occur when neglecting to account for heterogeneity and inframarginal production.)
