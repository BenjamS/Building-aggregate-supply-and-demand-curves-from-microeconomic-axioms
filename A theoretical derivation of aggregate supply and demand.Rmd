...
\begin{equation}
E[y^*(T)]|_{t = 0} = E[\tilde{y}^*(T)]|_{t = 0} E[k_m(T)^{\kappa_m}]|_{t = 0} \frac{k'}{E[k]} \frac{C^{*h}}{E[C^{*h}]} \:\:;\:\:\: \tilde{y}^*(T) = E[y^*(T)]
\label{eq:EyStarT0}
\end{equation}
...
Because the unconditional mean yield does not change $\tilde{y}^*(T) = E[\tilde{y}^*(T)]|_{t = 0}$,
