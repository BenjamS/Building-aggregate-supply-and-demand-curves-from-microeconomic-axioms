...
indRm <- which(abs(mod3$residuals) > 1.1)
...
notThese <- c("Dist", "Yield (kg/acre)", "Cost/acre (KES/acre)", bin_vars)
...
# }
#----------------------------------------------------------------------
muEcStarT0hSamp <- mean(exp(dfMod3$`Cost/acre (KES/acre)`)^h)
...
y0base <- v0base * muThetaK * muEcStarT0hSamp
...
y0 <- v0 * muThetaK * muEcStarT0hSamp
