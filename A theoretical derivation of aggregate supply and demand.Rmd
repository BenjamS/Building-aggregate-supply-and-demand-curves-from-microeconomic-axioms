...
As a final line of defense, proponents of conventional aggregate supply curves argue that there is no alternative to their approach of arbitrarily assuming a functional form for supply curves and supply curve shifts, however implausible or grossly inaccurate they might be. In their highly influential book, e.g., Alston et al. [-@alston1995science] write:
...
It is not economic theory, then, but rather a mathematical formulation which, by construction, precludes endogenous modeling of the aggregate supply response to exogenous shocks, that tells us "not very much" about the the aggregate supply response to exogenous shocks.
...
For the reasons outlined above, conventional aggregate supply and demand curves are ill suited to the assessment of any of these issues. To begin with, impact assessment results regarding consumer-producer tradeoffs vary considerably with the assumed functional form and type of supply curve shift [@alston2009economic]. Specifically, assessments based on a pivot of the linear or CES supply curve can result in consumer-producer tradeoffs, whereas assessments based on a linear parallel shift of the linear supply curve guarantee increases in both consumer and producer welfare. With no clear theoretical or empirical premise upon which to recommend one set of results over another, little confidence can be attached to any of them. This is remarkable considering that the primary motive for the conventional supply curve specifications is to facilitate the assessment of changes in consumer and producer surplus. It is also noteworthy that most agricultural R&D impact assessments assume the supply curve specification and type of shift that, by construction, sidestep any uncomfortable consumer-producer tradeoff issues, while also resulting in the highest possible net benefits [@hurley2014re; @alston2000research; @alston2009economic].
<!-- conspicuous -->

Conventional models are ill suited to the assessment of distributional questions because they either do not explicitly account for heterogeneous farm endowments (in the case of the CES curve), or, as noted earlier, assume a population of identically endowed marginal farms (in the case of the linear specification). In some sectors, one might reasonably justify the assumption of homogeneous firms by invoking competitive long run equilibrium. Such arguments are strained in the primary sector, however, where one typically sees an abundance of heterogeneously endowed, inframarginal farms in operation. Wohlgenant [-@wohlgenant1997nature] demonstrates that the long run equilibrium supply curve cannot be linear under such circumstances.

Proponents of the conventional approach even go so far as to expressly discourage the assessment of distributional questions vis-a-vis agricultural research, arguing that such issues lie beyond its scope.
...
While it is true agropessimism [@dethier2012agriculture], in fact, many economists think just the opposite. [@de2020using; @de2022agriculture]
