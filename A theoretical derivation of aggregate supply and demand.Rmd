...
But that is not all. The subsequent step of translating the exogenously introduced farm level response into an aggregate supply response is specified as a matter of methodological fiat. That is to say, after a long and inconclusive debate in the 1970s over whether the aggregate supply response should be represented as a pivot or parallel shift of the curve, or of some combination thereof [@alston1995science; @norton1981evaluating; @lindner1978supply], the parallel shift has emerged as the 
