...
The welfare effect on a given farm of adopting the new technology may be examined by differentiating $\mathcal{L}^*$ with respect to the change in TFP.
...
```{r Fig8, fig.show = "hold", fig.width = 5, fig.height=2, fig.align="left", fig.cap="\\label{fig:sumStats}Summary statistics for the 2007 Kenya long rains farm level maize data.", echo = FALSE}
...
gg <- gg + labs(title = "Table C1: Summary statistics for the 2007 Kenya long rains farm level maize data.", subtitle = "N = 937")
gg <- gg + theme_classic() +
