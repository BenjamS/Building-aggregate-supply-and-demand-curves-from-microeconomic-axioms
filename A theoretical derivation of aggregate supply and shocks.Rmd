...
Note that the percentage increase is the same across all adopting farms regardless of the starting value $g_{\phi}$.
...
The adoption rate within a single TFP stratum can be calculated by evaluating this expression at the $v_{\phi}$ of interest.
...
\text{Where} \:\: \theta &= E[C^{\#}(T)]|_{t = 0} \leq E[P(T)]|_{t = 0}
\end{split}
...
The price elasticity of expected aggregate supply follows as
