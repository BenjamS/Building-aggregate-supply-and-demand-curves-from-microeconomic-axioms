...
For purposes of impact assessment, the present work effectively replaces the exogenous guesswork of the conventional approach with endogenous modeling of the farm level supply and expenditure response to exogenous shock, and the aggregation of this response up to population level, based on axioms 1-4. There is no need for lengthy, abstract debates over which type of arbitrarily specified supply curve shift is best, no need to elicit the adoption rate from conflicted experts, and no need to trawl the literature for estimates of the price elasticity of supply. The adoption rate, type of shift, and supply elasticity are all endogenous to the model; and thus take their values based on the exogenous shock to total factor productivity, any associated changes in input and output prices, and any subsidy accompanying the technology package. The expert input of agronomists, plant breeders, pathologists, geneticists, and any other agricultural scientists involved in the research is thereby confined to its proper domain---i.e. the agronomic question of expected change to total factor productivity---leaving to policy makers and stakeholders much greater discretion over the socioeconomic dimensions of the assessment, particularly as regards policy levers (subsidies) and expected price changes.
