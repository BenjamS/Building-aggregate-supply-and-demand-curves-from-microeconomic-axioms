...
header-includes:
  ...
  - \usepackage{caption}
  - \captionsetup[figure]{font=small}  # Options: scriptsize, footnotesize, small
  - \usepackage{etoolbox}
...
The subsequent step of translating the exogenously introduced farm level response into an aggregate supply response likewise involves no explicit, endogenous modeling of economic behavior, but rather exogenous guesswork translated into mathematical symbols. Critically, this exogenous guesswork includes the adoption rate. That is to say, the adoption rate is "estimated" based upon the opinion of scientists closely involved in the research under evaluation, with little or no grounding in economic arguments. As for the type of supply curve shift---i.e. whether it be a shift or pivot or some combination thereof---the current default choice of parallel shift in most impact assessments comes down to us---after a long and inconclusive debate in the 1970s [@alston1995science; @norton1981evaluating; @voon1991calculation]---not on any theoretical or empirical basis, but as a matter of fiat [@alston2009economics]. The parallel shift also happens to be, surely by pure coincidence, the type of shift that results in the highest possible net benefit calculation, and that, by construction, precludes the possibility of a food-price dilemma (i.e. producer-consumer net benefit tradeoffs).
...
Not at the cost of, then, but rather in addition to computational convenience, the axiomatic approach described here presents numerous methodological strengths not found in the conventional approach. In particular, the aggregation of farm level behavior up to the population level explicitly accounts for entry and exit (via axiom 3) and the shape of the distribution (axiom 4), resulting in an endogenous assessment of the farm employment rate as a byproduct. Because the model explicitly accounts for the yield distribution, which is in turn related theoretically to the expenditure distribution (via axioms 1 and 2), the proposed model is well equipped to address questions of distributional equity. The conventional approach, by contrast, readily admits that it cannot address such questions [@norton1992economic]. (In its defense, the conventional approach argues that distributional questions are irrelevant to agricultural research [@norton1992economic; @alston1995science], quite contrary to the modern consensus [@byerlee2009agriculture; @valdes2010reflections; @world2007world; @de2020using; @de2022agriculture].)

For purposes of impact assessment, the present work effectively replaces the exogenous guesswork of the conventional approach with endogenous modeling of the farm level supply and expenditure response to exogenous shock, and the aggregation of this response up to population level, based on axioms 1-4. There is no need for lengthy, abstract debates over which type of arbitrarily specified supply curve shift is best, and no need to elicit the adoption rate from conflicted experts. The adoption rate and type of shift are endogenous to the model; and thus take their values based on the exogenous shock to total factor productivity, any associated changes in input and output prices, and any subsidy accompanying the technology package. The expert input of agronomists, plant breeders, pathologists, geneticists, and any other agricultural scientists involved in the research under evaluation is thereby confined to its proper domain---i.e. the agronomic question of expected change to total factor productivity---allotting to policy makers and stakeholders much greater discretion over the economic dimensions of the assessment, particularly as regards policy levers (subsidies) and expected price changes.

The theoretical derivation also results in an endogenous expression for the price elasticity of aggregate supply. The conventional approach, by contrast, requires the price elasticity of aggregate supply as an exogenous input parameter, the estimation of which constitutes a paper-length research project unto itself. In a typical impact assessment, the time and resources required to conduct such prerequisite studies are generally not available; and previously published estimates rarely cover the exact commodity and geographical focus in question. The conventional framework's exogenous treatment of supply (and demand) elasticity thus confronts the practitioner with a formidable methodological bottleneck. The present work effectively removes this bottleneck by demonstrating that, under weak axioms, the price elasticity of aggregate supply varies endogenosly with output price and other parameters, and thus requires no exogenous estimation.
