...
Subsequent work is free to modify the set of axioms. The point is to set out from axioms that sensibly and elegantly characterize the socioeconomic behavior in question; as opposed to setting out from a notion of what sort of functional form will facilitate computations. The present work effectively demonstrates that the very presumption of a tradeoff between theoretical rigor and computational convenience, which presumably motivates the conventional approach, is null. On the contrary, the theoretical derivation here results in tractable, instructive, closed form expressions for aggregate supply and producer welfare impacts in response to shocks. Extension of the framework to include aggregate demand and consumer side impacts is briefly outlined in the Discussion and Conclusion.
...
Not at the cost of, then, but rather in addition to computational convenience, the axiomatic approach described here offers the benefits of a theoretically derived model, which are not found in the conventional approach. First and foremost, it rests entirely upon standard microeconomic assumptions regarding rational economic behavior at the farm level (axioms 1 and 2). The aggregation of farm level behavior up to the population level explicitly accounts for entry and exit (via axiom 3) and the shape of the distribution (axiom 4), resulting in an endogenous assessment of the farm employment rate as a byproduct. Because the model explicitly accounts for the yield distribution, which is in turn related theoretically to the expenditure distribution (via axioms 1 and 2), the proposed model is well equipped to address questions of distributional equity. The conventional approach, by contrast, readily admits that it cannot address such questions; and even goes so far as to argue that distributional questions are irrelevant to agricultural research [@norton1992economic], quite contrary to the more recent consensus [].

For purposes of impact assessment, the present work effectively replaces the exogenous guesswork of the conventional approach with endogenous modeling of the farm level supply and expenditure response to exogenous shock, and the aggregation up to population level, follow from axioms 1-4. No need to elicit opinion on adoption rate or to debate the type of supply curve shift, as this is wholly endogenous to the model based on the expected shock to total factor productivity, prices, and the subsidy level, .

axiomatically explicit foundation
results in a clear mathematical delineation of the boundary and relation between the exogenous shock, on the one hand, and the economically rational endogenous farm level response to the shock, on the other. The aggregation of the farm level response up to the population level similarly replaces the exogenous guesswork of the conventional approach with an endogenous assessment of the adoption rate and type of supply curve shift. The type of supply curve shift 
<!-- (diminishing marginal returns, profit maximization, homogeneity, convexity, and the slope of supply and demand curves, all of which stem from axioms 1 and 2) -->

Finally, the model explicitly accounts for the stochastic nature of meteorological conditions and output price. A pedagogical example using Kenya maize farm data underscores just how sensitive the supply curve can be to meteorological conditions, such that it may be more instructive to speak of a supply "ribbon" bounded above and below by supply curves estimated under the expected best and worst case meteorological conditions. Explicit accounting for output price 


All of the parameters appearing in the derived model have a straightforward interpretation in terms of relevant, measurable, empirical phenomena, facilitating the exploration of distributional policy issues that conventional modeling approaches are admittedly ill suited to address [@norton1992economic]. This includes, in addition to the usual variables of interest (technology, agroclimatic variables, output price), farm expenditure population parameters and terms capturing the farm employment rate (i.e. farm entry/exit) and mean probability of profit. When axiom 5 is introduced, the aggregate supply curve is shown to have a dual expression in stochastic price parameter space, whereby questions of price volatility may be addressed. This 
